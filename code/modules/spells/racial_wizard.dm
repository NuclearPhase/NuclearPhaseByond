...
/obj/item/weapon/storage/bag/cash/infinite
	startswith = list(/obj/item/weapon/reagent_containers/food/snacks/protein_package/bundle/c1000 = 1)

//HUMAN
/obj/item/weapon/storage/bag/cash/infinite/remove_from_storage(obj/item/W as obj, atom/new_location)
	. = ..()
	if(.)
		if(istype(W,/obj/item/weapon/reagent_containers/food/snacks/protein_package)) //only matters if its spacecash.
			var/obj/item/I = new /obj/item/weapon/reagent_containers/food/snacks/protein_package/bundle/c1000()

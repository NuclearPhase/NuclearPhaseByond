...
/mob/living/carbon/human/handle_environment(datum/gas_mixture/environment)
	...
	if(istype(src.loc, /turf/unsimulated/floor/outwards)) //being in a closet will interfere with radiation, may not make sense but we don't model radiation for atoms in general so it will have to do for now.

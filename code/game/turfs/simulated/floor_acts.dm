...
/turf/simulated/floor/fire_act(datum/fluid_mixture/air, exposed_temperature, exposed_volume)
...
/turf/simulated/floor/adjacent_fire_act(turf/simulated/floor/adj_turf, datum/fluid_mixture/adj_air, adj_temp, adj_volume)
